...
var file_user_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x74, 0x61, 0x32, 0xf7, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x37, 0x0a,
	...
	0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x09,
...
var file_user_proto_goTypes = []interface{}{
	(*PageInfo)(nil),          // 0: proto.PageInfo
	(*CheckResponse)(nil),     // 1: proto.CheckResponse
	(*PasswordCheckInfo)(nil), // 2: proto.PasswordCheckInfo
	(*UpdateUserInfo)(nil),    // 3: proto.UpdateUserInfo
	(*CreateUserInfo)(nil),    // 4: proto.CreateUserInfo
	(*IdRequest)(nil),         // 5: proto.IdRequest
	(*MobileRequest)(nil),     // 6: proto.MobileRequest
	(*UserInfoResponse)(nil),  // 7: proto.UserInfoResponse
	(*UserListResponse)(nil),  // 8: proto.UserListResponse
	(*emptypb.Empty)(nil),     // 9: google.protobuf.Empty
}
var file_user_proto_depIdxs = []int32{
	7, // 0: proto.UserListResponse.data:type_name -> proto.UserInfoResponse
	0, // 1: proto.User.GetUserList:input_type -> proto.PageInfo
	6, // 2: proto.User.GetUserByMobile:input_type -> proto.MobileRequest
	5, // 3: proto.User.GetUserById:input_type -> proto.IdRequest
	4, // 4: proto.User.CreateUser:input_type -> proto.CreateUserInfo
	3, // 5: proto.User.UpdateUser:input_type -> proto.UpdateUserInfo
	2, // 6: proto.User.CheckPassWord:input_type -> proto.PasswordCheckInfo
	8, // 7: proto.User.GetUserList:output_type -> proto.UserListResponse
	7, // 8: proto.User.GetUserByMobile:output_type -> proto.UserInfoResponse
	7, // 9: proto.User.GetUserById:output_type -> proto.UserInfoResponse
	7, // 10: proto.User.CreateUser:output_type -> proto.UserInfoResponse
	9, // 11: proto.User.UpdateUser:output_type -> google.protobuf.Empty
	1, // 12: proto.User.CheckPassWord:output_type -> proto.CheckResponse
