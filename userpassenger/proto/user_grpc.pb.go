...
type UserClient interface {
	GetUserList(ctx context.Context, in *UserPageInfo, opts ...grpc.CallOption) (*UserListResponse, error)
	...
	AddPassenger(ctx context.Context, in *PassengerInfo, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *userClient) GetUserList(ctx context.Context, in *UserPageInfo, opts ...grpc.CallOption) (*UserListResponse, error) {
...
func (c *userClient) AddPassenger(ctx context.Context, in *PassengerInfo, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type UserServer interface {
	GetUserList(context.Context, *UserPageInfo) (*UserListResponse, error)
	GetUserByMobile(context.Context, *MobileRequest) (*UserInfoResponse, error)
	GetUserById(context.Context, *IdRequest) (*UserInfoResponse, error)
	CreateUser(context.Context, *CreateUserInfo) (*UserInfoResponse, error)
	UpdateUser(context.Context, *UpdateUserInfo) (*emptypb.Empty, error)
	CheckPassWord(context.Context, *PasswordCheckInfo) (*CheckResponse, error)
	AddPassenger(context.Context, *PassengerInfo) (*emptypb.Empty, error)
...
func (UnimplementedUserServer) GetUserList(context.Context, *UserPageInfo) (*UserListResponse, error) {
...
func (UnimplementedUserServer) AddPassenger(context.Context, *PassengerInfo) (*emptypb.Empty, error) {
...
func _User_GetUserList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).GetUserList(ctx, req.(*UserPageInfo))
	}
