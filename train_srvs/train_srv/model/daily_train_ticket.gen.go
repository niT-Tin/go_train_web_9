...
const TableNameDailyTrainTicket = "daily_train_ticket"

// DailyTrainTicket mapped from table <daily_train_ticket>
...
// TableName DailyTrainTicket's table name
func (*DailyTrainTicket) TableName() string {
	return TableNameDailyTrainTicket
}
